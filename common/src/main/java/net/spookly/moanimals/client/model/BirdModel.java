...
public class BirdModel<T extends Bird> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        body.addOrReplaceChild("wing_right", CubeListBuilder.create().texOffs(0, 13).addBox(0.0F, 0.0F, -0.5F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.01F, -3.25F, 0.0F, 0.0F, 0.0F, -0.2618F));
        body.addOrReplaceChild("wing_left", CubeListBuilder.create().texOffs(0, 13).addBox(0.0F, 0.0F, -0.5F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.9999F, -3.25F, 0.0F, 0.0F, 0.0F, 0.3054F));
        body.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(0, 8).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 1.5F));
        ...
        leg_right.addOrReplaceChild("foot_right", CubeListBuilder.create().texOffs(10, 19).addBox(1.5F, 2.0F, -3.5F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 0.0F, 1.5F));
        ...
        leg_left.addOrReplaceChild("foot_left", CubeListBuilder.create().texOffs(18, 19).addBox(-0.5F, 1.0F, -1.5F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0F, -0.5F));
