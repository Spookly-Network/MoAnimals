...
public class MoAnimalsEntityDataSerializers {
    ...
    public static final EntityDataSerializer<Holder<BirdVariant>> BIRD_VARIANT = EntityDataSerializer.forValueType(BirdVariant.STREAM_CODEC);
    ...
    public static void init() {
        ...
        CommonPlatformHelper.registerEntityDataSerializers("bird_variant", () -> BIRD_VARIANT);
    }
}
